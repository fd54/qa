...
test_file = os.path.join(home, "data", "test1.json")
glove_word_file = os.path.join(home, "data", "glove", "sgns.baidubaike.bigram-char")

target_dir = "data"
event_dir = "log"
save_dir = "model"
answer_dir = "log"
train_record_file = os.path.join(home, target_dir, "train.npz")
dev_record_file = os.path.join(home, target_dir, "dev.npz")
test_record_file = os.path.join(home, target_dir, "test.npz")
word_emb_file = os.path.join(home, target_dir, "word_emb.json")
char_emb_file = os.path.join(home, target_dir, "char_emb.json")
train_eval_file = os.path.join(home, target_dir, "train_eval.json")
dev_eval_file = os.path.join(home, target_dir, "dev_eval.json")
test_eval_file = os.path.join(home, target_dir, "test_eval.json")
dev_meta_file = os.path.join(home, target_dir, "dev_meta.json")
test_meta_file = os.path.join(home, target_dir, "test_meta.json")
word2idx_file = os.path.join(home, target_dir, "word2idx.json")
char2idx_file = os.path.join(home, target_dir, "char2idx.json")
answer_file = os.path.join(home, answer_dir, "answer.json")
